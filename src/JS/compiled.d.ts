...
declare function deviceType(): "tablet" | "mobile" | "desktop";
declare const ISMOBILE: boolean;
declare const ISTABLET: boolean;
declare const ISDESKTOP: boolean;
declare const MOBILEVIEW: boolean;
...
declare const PauseModalOpenerButton: HTMLButtonElement;
declare const PauseModalOpenerIcon: HTMLSpanElement;
