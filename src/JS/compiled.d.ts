...
declare const OptionsSoundSwitch: HTMLInputElement;
declare const OptionsParticleSwitch: HTMLInputElement;
declare const OptionsMusicSwitch: HTMLInputElement;
...
declare class MusicPlayer {
    ...
    get track(): number;
    set track(v: number);
    get trackAudio(): HTMLAudioElement;
    AddTrack(v: HTMLAudioElement): void;
    play(i: number): void;
    shuffle(current?: HTMLAudioElement): void;
    set ContinuePlaying(v: boolean);
}
